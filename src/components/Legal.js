...
• When you sign an email with its shortcut, it certifies the email you have written (read once through Accessibility, like any certificate), puts a picture of your name on the clipboard and pastes it. The picture links to the certificate and carries its code in its description and in slight variations of its ink. The name you sign with is stored on your Mac and is written into that certificate as its author.
